    ...
    <div className='w-full h-screen bg-[url(./background.jpg)] bg-cover bg-center flex justify-center items-center'>
      ...
      <div className='w-[500px] h-[500px] backdrop-blur-sm rounded-[30px] shadow-2xl text-white flex flex-col items-center justify-center relative gap-[20px]'>
        ...
        <div className='w-[350px] flex flex-col  '>
          ...
          <input type="text" className='w-[350px] h-[60px] border border-white rounded-xl focus:border-blue-600 focus:outline-none text-black'/>
        </div>
        <div className='w-[350px] flex flex-col  '>
          <span className='text-lg  '>Password</span>
          <input type="password" className='w-[350px] h-[60px] border border-white rounded-xl focus:border-blue-600 focus:outline-none text-black'/>
        </div>

        <button className='w-[350px] h-[40px] bg-blue-700 rounded-xl text-white text-lg mt-5 hover:bg-blue-500 transition-all duration-300'>Login</button>
